...
################################################################
# This is a generated script based on design: lab7_pynq_z2
#
...
# source lab7_pynq_z2.tcl

# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./lab7_pynq_z2/lab7_pynq_z2.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project lab7_pynq_z2 lab7_pynq_z2 -part xc7z020clg400-1
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {142.000} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {118.758} \
   CONFIG.CLKOUT3_PHASE_ERROR {98.575} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {166.000} \
  ...
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps7_0/FCLK_CLK0]
  connect_bd_net -net ps7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in] [get_bd_pins ps7_0/FCLK_RESET0_N]
